...
def request_status():
    ...
    <div class='public-form' style='max-width:650px'>
        ...
        <form method='POST'>
            ...
            <input name='contact_last4' inputmode='numeric' maxlength='4' pattern='[0-9]{4}' placeholder='1234' required>
...
def delete_record(record_id):
    ...
    if old_record:
        log_record_activity("Deleted record", record_id, old_type, old_name)
